...
const SocialIcons = (props) => {
    ...
    return (
        <Icons>  
            ...
            >
                <NavLink target='_blank' to= {{pathname: "https://www.facebook.com/profile.php?id=100014174467444"}}>
            ...
            >
                <NavLink target='_blank' to= {{pathname: "https://github.com/Priyanshu1234-kumar"}}>
            ...
            >
                <NavLink target='_blank' to= {{pathname: "https://www.linkedin.com/in/priyanshu-kumar-b9ba611ba"}}>
            ...
            >
                <NavLink target='_blank' to= {{pathname: "https://www.instagram.com/intellect_ig"}}>
