        ...
        <ThemeProvider theme={DarkTheme}>
            <Suspense fallback={<PreLoader />}>
                ...
                >
                    ...
                    >
                        Currently, I am a B.Tech student at VIT Vellore pursuing Electrical & Electronics Engineering.
                        I'm a full-stack developer located in India. I love to create simple yet beautiful websites with great user experience.
                        <br /> <br />
                        I'm interested in the whole frontend and backend stacks Like trying new things and building great projects. I am a cricket enthusiast and music is my escape. I love to write blogs and read books.
                        <br /> <br />
                        I believe everything is an Art when you put your consciousness in it. You can connect with me via social links.
                        Feel free to reach out to me !
                        <br /> <br />
                        <Resume>
                            <a href='priyanshu.resume.pdf' style={{ textDecoration: 'none' }} target='_blank'>
