...
import { HTML, CSS, Javascript, C, JAVA, Reactjs, Node, VSCode, Bootstrap, Heroku, Vercel } from '../subComponents/Skill-IconsSvgs'
            ...
            <Suspense fallback= {<PreLoader />}>
                <Box>
                    ...
                    <Main>
                        ...
                        <Description>   
                           I love to create design which speaks, Keep it clean, minimal and simple. Challenging and creative web designs excites me !<br/>                             
                        </Description>
                        <Description>
                    ...
                    <Main>
                        ...
                        <Description>   
                        I value business or brand for which i'm creating, thus i enjoy bringing new ideas to life. I love to do backend part of website as well.                   
                        </Description>
                        <Description>
                            <strong>LANGUAGES</strong>
                                <ul>
                                    ...
                                    <div>
                                        <li><Node width= {matchQuery ? 15 : 20} height= {matchQuery ? 15 : 20}/>&nbsp;Python</li>
                                        <li><CSS width= {matchQuery ? 15 : 20} height= {matchQuery ? 15 : 20}/>&nbsp;Django</li>
                                    </div>
                                </ul>
                        </Description>
                        <Description>
