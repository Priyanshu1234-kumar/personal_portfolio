...
const ExpEduPage = () => {
    ...
    return (        
        <Suspense fallback= {<PreLoader />}>
            ...
            >    
                <MetaTag 
                    title= "EduExp &amp; Blog - Priyanshu Kumar"
                    description= "My education and experience till date."
                    imageUrl= {thumbnail}
                ...
                <EducationContainer id='edu-container'>    
                    ...
                    <BGContainer>
                        <BackgroundTitle text= "EDUEXP" top= '5rem' left= { matchQuery ? '3rem' : '5rem' } />
                    </BGContainer>
                    <BGContainer>
                ...
                <ExperienceContainer id='exp-container'>
                    ...
                    <BGContainer >
                        <BackgroundTitle text= "BLOG" bottom= '2rem' right= { matchQuery ? '1.5rem' : '5rem' } />
                    </BGContainer>
